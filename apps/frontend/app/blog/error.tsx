...
export default function BlogListError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-4 text-center">
      <p className="text-4xl">✍️</p>
      <h2 className="font-serif text-2xl text-primary">Blog unavailable</h2>
      <p className="text-sm text-text/60">Could not load articles right now. Please try again.</p>
