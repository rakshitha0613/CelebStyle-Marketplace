      ...
      <div className="flex gap-4 overflow-x-auto pb-3" style={{ scrollbarWidth: "thin" }}>
        {outfits.map((outfit) => (
          <Link
            ...
            className="group w-44 shrink-0 overflow-hidden rounded-[20px] border border-black/6 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-luxe"
          >
